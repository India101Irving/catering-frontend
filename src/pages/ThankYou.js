...
export default function ThankYou() {
  ...
  // Use order placed time (state.placedAt) if present; otherwise now.
  ...
  // If arriving from Stripe success URL, session_id may be present
  ...
  return (
    <div className="min-h-screen bg-[#1c1b1b] text-white p-4 md:p-6 relative flex items-center justify-center">
      {/* Soft backdrop for depth (kept subtle on mobile) */}
      <div className="fixed inset-0 bg-black/50" aria-hidden="true" />

      {/* Card */}
      <div className="relative z-10 w-full max-w-xl bg-[#2c2a2a] border border-[#3a3939] rounded-2xl p-5 md:p-6 shadow-xl">
        <div className="flex flex-col items-center md:items-start gap-3 mb-3 text-center md:text-left">
          <div className="h-10 w-10 rounded-full bg-[#F58735] flex items-center justify-center font-bold text-black">✓</div>
          <h1 className="text-2xl md:text-3xl font-bold text-orange-400">Thank you!</h1>
        </div>
        ...
        <div className="mt-6 flex md:justify-end">
          <button
            ...
            className="w-full md:w-auto px-5 py-2 rounded bg-[#F58735] hover:bg-orange-600 text-black font-medium"
          >
            Back to Home
          </button>
        </div>
        ...
        {hasStripeSession ? (
          <div className="mt-3 text-[11px] text-neutral-500 text-center md:text-left">
