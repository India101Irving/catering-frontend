...
export default function IndexChooser() {
  ...
  return (
    <div className="min-h-screen bg-[#1c1b1b] text-white p-4 md:p-6 relative overflow-hidden">
      {/* ✅ Background food image (faded) */}
      <div
      ...
      <div className="relative z-10">
        ...
        <p className="mb-4 md:mb-6 text-base md:text-lg max-w-3xl">
        ...
        <div className="mb-4 md:mb-6 rounded-xl border border-[#3a3939] bg-gradient-to-br from-[#2a2626] to-[#1f1d1d] p-4 md:p-5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto bg-[#F58735] hover:bg-orange-600 text-white font-medium px-4 py-2 rounded"
            >
              Start an Order →
            </button>
          </div>
        ...
        <div className="mb-4 md:mb-6 grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="rounded-xl border border-[#3a3939] bg-[#232222]/90 p-4">
            <div className="text-sm text-neutral-200">
              <span className="font-semibold text-[#F58735]">Heads up:</span>{' '}
              Online per-person packages are limited to 100 guests. Please contact India 101 for larger events or requests.          
            </div>
          </div>
          <div className="rounded-xl border border-[#3a3939] bg-[#232222]/90 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-4xl">
          <button
            onClick={() => nav('/OrderPackage')}
            className="flex flex-col justify-between bg-[#272525]/95 hover:bg-[#353232] border border-[#F58735]/60 rounded-xl p-5 md:p-6 text-left transition"
          >
            <div>
